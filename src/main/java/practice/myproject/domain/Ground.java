...
public class Ground {
    ...
    @Builder
    public Ground(Long id, Double x, Double y, String address, String groundName, String callNumber, String placeUrl, String showerYn, String sportsWearYn, String shoesYn, String parkingYn, Match match) {
        this.id = id;
        this.x = x;
        this.y = y;
